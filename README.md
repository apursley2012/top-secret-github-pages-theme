<!--
File: README.md
Document Title: Top Secret Theme Documentation
...
# Top Secret Theme Documentation
</div>
...
### Section Title: Top Secret Static Website Theme Documentation
...
![Top Secret Homepage preview](images/top-secret-screenshot-01.png)

#### Additional theme preview 2

![Top Secret Additional theme preview 2](images/top-secret-screenshot-02.png)

#### Additional theme preview 3

![Top Secret Additional theme preview 3](images/top-secret-screenshot-03.png)

#### Additional theme preview 4

![Top Secret Additional theme preview 4](images/top-secret-screenshot-04.png)

#### Additional theme preview 5

![Top Secret Additional theme preview 5](images/top-secret-screenshot-05.png)

#### Additional theme preview 6

![Top Secret Additional theme preview 6](images/top-secret-screenshot-06.png)
...
| Writing | `writing.html` | Supports the theme’s navigation and gives the site owner another editable content area. |
...
|---|---|---|
| Chrome Button | `components/chrome-button.html` | Reusable section used across the theme. |
...
| Hit Counter | `components/hit-counter.html` | Reusable section used across the theme. |
| Layout | `components/layout.html` | Holds shared structure used by multiple pages, including repeated wrapper markup. |
| Marquee Ticker | `components/marquee-ticker.html` | Reusable section used across the theme. |
| Pixel H P Bar | `components/pixel-h-p-bar.html` | Reusable section used across the theme. |
| Polaroid | `components/polaroid.html` | Reusable section used across the theme. |
| Webring Nav | `components/webring-nav.html` | Controls the top navigation, site title, page links, and first impression branding. |
...
```text
images/top-secret-homepage-preview.png
images/top-secret-profile-photo.png
images/top-secret-project-one.png
images/top-secret-project-two.png
```
